...
% This deviates from the principle of an ideal AI algorithm, which is to make machines think like human.  Obviously, human beings only need very few data to learning a new thing.
...
%% We solve this problem in a human-in-the-loop manner.																																							
